...
export class AiController {
	...
	@Post('/build', { ipRateLimit: { limit: 1000, windowMs: 60000 }, usesTemplates: true })
	async build(
	...
	@Post('/chat', { ipRateLimit: { limit: 1000, windowMs: 60000 } })
	...
	@Licensed('feat:aiBuilder')
	@Post('/sessions', { ipRateLimit: { limit: 1000, windowMs: 60000 } })
	async getSessions(
		req: AuthenticatedRequest,
		_: Response,
	...
	@Licensed('feat:aiBuilder')
	@Post('/build/truncate-messages', { ipRateLimit: { limit: 1000, windowMs: 60000 } })
